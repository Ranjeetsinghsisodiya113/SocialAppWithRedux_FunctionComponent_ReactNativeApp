...
const Home = ({ navigation }) => {
    ...
    const userStory = [
        {
            name: "RJ",
            image: localimag.user_1,
            story_image: localimag.img_icon,
        },
        {
            name: "Herry",
            image: localimag.user_2,
            story_image: localimag.funny_icon,
        },
        {
            name: "Russel",
            image: localimag.user_4,
            story_image: localimag.user_3,
        },
        // Add more user story data as needed...
    ];
...
<Modal
            ...
            <Story navigation={navigation} userStory={userStory} />
            <View style={{
                ...
                <TouchableOpacity
                    activeOpacity={0.9}
                    onPress={() => {
                        navigation.navigate('HomePostViewAll');
                    }}
                >
                    <Text style={{
            ...
            <View style={{
                height: mobileHeight * 70 / 100,
                justifyContent: 'center'
            }}>
                {console.log("post list",postList)}
                {( postList!=null && postList!='NA') &&
                <FlatList
