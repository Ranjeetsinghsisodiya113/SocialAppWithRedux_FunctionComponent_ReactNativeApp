...
const PostDetails = (props) => {
    ...
    useEffect(() => {
        console.log('item:props.route.params.item', props.route.params.item);
    ...
    return (
        <View style={{ flex: 1 }}>
                        ...
                        <View style={{ backgroundColor: Colors.whitecolor, borderRadius: 15, width: '94%', paddingVertical: mobileWidth * 3.3 / 100, alignSelf: 'center' }}>
                            ...
                            >
                                <Text style={{
                                    ...
                                    , fontSize: mobileWidth * 4 / 100, alignSelf: 'center', fontFamily: Font.FontMedium
                                }}>{"Select Option"}</Text>
                            </View>
            ...
            <HeaderWithBack title={"POST DETAILS"} navigation={props.navigation} />
